"""
Django settings for eco_tech project.
...
ALLOWED_HOSTS = [
    "localhost",
    "127.0.0.1",
    "lk6al5vc9b.execute-api.ap-south-1.amazonaws.com",
]
...
WSGI_APPLICATION = "eco_tech.wsgi.application"
...
STATIC_URL = "static/" if DEBUG else "https://d37sx5th1ij9bi.cloudfront.net/"
